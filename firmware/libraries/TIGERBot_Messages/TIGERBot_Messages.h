...
#ifndef _TIGERBOT_MESSAGES_h_
#define _TIGERBOT_MESSAGES_h_
...
//------------------------------------------------------------------------------
/*Apparently, all SET messages are received by the bots
			  all GET messages are sent by the bots */ //TS 1/14/2021
...
#define MSG_SET_STEP_DURATION     7
...
#define MSG_FLASH_LEDS 				120
#define MSG_READ_DIODE 				121

/* Decentralized communication */ // Steve
#define MSG_SET_DECENTRALIZED         154
#define MSG_SET_DIRECTOR              155
#define MSG_SET_CONTROL_GAIN          156
#define MSG_GET_DIRECTOR              157

//Added : 01/14/2021
#define MSG_CONSTANT_VELOCITY			160
#define MSG_RECEIVE_CONSTANT_VELOCITY	161

//Added : 02/22/2021
//Algorithm commands
#define MSG_SET_ALL_INITIAL_POSES						162
//#define_MSG_SET_ROBOT_IDS								163
#define MSG_SET_TARGET_POSES							166
#define MSG_SET_ALGORITHM_PARAMETERS					167
#define MSG_RESET_ALGORITHM_PARAMETERS					168

//ALGORITHMS
#define	MSG_RUN_moveToPositions							169
#define MSG_RUN_dock									170

#define	MSG_RUN_Directed_Distance_Angle_1				171
#define	MSG_RUN_Directed_Distance_Area_3				172
#define	MSG_RUN_Directed_Distance_Area_4				173
#define	MSG_RUN_Directed_Distance_Area_6				174
#define	MSG_RUN_TS_AngleConstraints						175
#define	MSG_RUN_TS_AngleConstraints_Switch				176
#define	MSG_RUN_TS_AreaConstraints						177
#define	MSG_RUN_TS_AreaConstraints_Switch				178
#define	MSG_RUN_TS_DirectedManeuvering					179
#define	MSG_RUN_TS_FlockingControl_estimate_in_loop_v5	170
#define	MSG_RUN_TS_FlockingControl_estimate_in_loop_v6	181
#define	MSG_RUN_TS_FlockingControl_v3					182
#define	MSG_RUN_TS_Orthogonal_Basis_2D					183
#define	MSG_RUN_TS_UndirectedManeuvering				184
